      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        {AI_FEATURES.map((feature, i) => (
          ...
          >
            ...
            {feature.badge && (
              <span
                className="absolute top-3.5 left-3.5 text-[11px] font-bold px-2 py-0.5 rounded-md tracking-wider"
                style={{
            ...
            {feature.clickable ? (
              ...
              <div className="absolute bottom-3.5 left-3.5 text-[11px] text-[#4a5280]/60 flex items-center gap-1 border border-[#4a5280]/20 px-2 py-0.5 rounded-md">
                قريباً
              </div>
            )}
          </motion.div>
