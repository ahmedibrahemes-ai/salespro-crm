    ...
    <div className="space-y-5 animate-in fade-in duration-300" dir="rtl" style={{ fontFamily: 'Cairo, sans-serif' }}>
      ...
      <div>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            <h1 className="text-[20px] md:text-[24px] font-extrabold text-[#f0f2ff] flex items-center gap-2.5">
              <BarChart3 size={24} className="text-[#6c63ff]" />
              حالة العملاء
            </h1>
            <p className="text-[14px] font-semibold text-[#8892b0] mt-1">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="bg-[#111520] border-white/[0.06] text-[#f0f2ff] placeholder:text-[#4a5280] pr-9 h-9 text-[14px] rounded-xl w-full sm:w-[200px]"
            ...
            <Select value={memberFilter} onValueChange={setMemberFilter}>
              <SelectTrigger
                className="bg-[#111520] border-white/[0.06] text-[#f0f2ff] h-9 text-[14px] rounded-xl w-full sm:w-[180px]"
                style={{ fontFamily: 'Cairo, sans-serif' }}
              >
        ...
        {kpiCards.map((kpi, i) => {
          ...
          return (
            ...
            >
              ...
              {/* Label */}
              <div className="text-[14px] font-bold text-[#8892b0] mt-0.5">{kpi.label}</div>
            </div>
          )
        })}
      </div>
      ...
      <Card className="bg-[#111520] border-white/[0.06] rounded-2xl overflow-hidden">
        ...
        <CardContent className="space-y-3">
            ...
            return (
              <div key={status.key} className="group">
                <div className="flex items-center gap-3">
                  {/* Label */}
                  <div className="w-32 md:w-40 text-[14px] font-bold text-[#f0f2ff] shrink-0 flex items-center gap-1.5">
                  ...
                  {/* Percentage */}
                  <div
                    className="w-14 text-left text-[13px] font-bold shrink-0"
          ...
          <div className="mt-3 pt-3 border-t border-white/[0.06] flex items-center justify-between">
            <span className="text-[14px] font-semibold text-[#8892b0]">إجمالي العملاء النشطين</span>
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-white/[0.06] hover:bg-transparent">
                  <TableHead className="text-[#8892b0] text-[13px] font-bold text-right">
                    العضو
                  </TableHead>
                  <TableHead className="text-[#8892b0] text-[13px] font-bold text-right">
                    الدور
                  </TableHead>
                  <TableHead className="text-[#8892b0] text-[13px] font-bold text-center">
                    إجمالي
                  </TableHead>
                  <TableHead className="text-[#8892b0] text-[13px] font-bold text-center">
                    تم التواصل
                ...
                {filteredTeamPerf.length > 0 ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={6} className="text-center py-8">
                      <div className="text-[14px] font-semibold text-[#4a5280]">
