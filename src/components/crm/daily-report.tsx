            ...
            <Table>
              ...
              <TableBody>
                {computed.teamActivity.length > 0 ? (
                      ...
                      >
                        <TableCell className="text-right">
                          <div className="flex items-center gap-2 justify-end">
                            ...
                            {isTop && <span className="text-[16px]" title="أفضل أداء">👑</span>}
                          </div>
                        </TableCell>
                        ...
                        <TableCell className="text-center">
                          <span
                            className={`text-[15px] font-bold ${isTop ? 'text-[#6c63ff]' : 'text-[#f0f2ff]'}`}
                            style={{ fontFamily: 'Cairo, sans-serif' }}
                          >
                            {member.total}
                          </span>
                  ...
                  <TableRow>
                    <TableCell colSpan={8} className="text-center py-6 text-[#4a5280] text-[15px]">
