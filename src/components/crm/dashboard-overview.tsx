    ...
    >
          ...
          {pipelineData.map((stage, i) => {
            ...
            return (
              <div key={stage.key} className="flex-1 flex flex-col items-center gap-2">
                ...
                />
                <span className="text-[11px] text-[#4a5280] whitespace-nowrap">{stage.label}</span>
              </div>
            )
          })}
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-[#111520] border border-white/[0.06] rounded-2xl p-5 text-center">
          ...
          <div className="text-[30px] font-extrabold text-[#00d4aa]" style={{ fontFamily: 'Cairo, sans-serif' }}>
            {totalCallHours} ساعة
          </div>
          ...
          <div className="flex justify-center gap-5 mt-4 pt-3 border-t border-white/[0.06]">
            <div>
              <div className="text-[17px] font-bold text-[#00d4aa]" style={{ fontFamily: 'Cairo, sans-serif' }}>
                {callAnalytics.successCount}
              </div>
              <div className="text-[11px] text-[#8892b0]">ناجحة</div>
            </div>
            <div>
              <div className="text-[17px] font-bold text-[#ff6b6b]" style={{ fontFamily: 'Cairo, sans-serif' }}>
                {callAnalytics.failCount}
              </div>
              <div className="text-[11px] text-[#8892b0]">فاشلة</div>
            </div>
            <div>
              <div className="text-[17px] font-bold text-[#6c63ff]" style={{ fontFamily: 'Cairo, sans-serif' }}>
        ...
        <div className="bg-[#111520] border border-white/[0.06] rounded-2xl p-5 text-center">
          ...
          <div className="relative inline-flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span className="text-[30px] font-black text-[#6c63ff] leading-none" style={{ fontFamily: 'Cairo, sans-serif' }}>
                {aiScore.toFixed(1)}
              </span>
        ...
        <div className="bg-[#111520] border border-white/[0.06] rounded-2xl p-5 text-center">
          ...
          <div className="text-[19px] font-bold text-[#ffd166] mt-2" style={{ fontFamily: 'Cairo, sans-serif' }}>
            المركز الأول
          </div>
