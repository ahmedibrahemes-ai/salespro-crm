  ...
  return (
    <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      ...
      <div className="flex items-center justify-between mb-5 flex-wrap gap-3">
        <div>
          <h2 className="text-[17px] font-bold text-[#f0f2ff]">Follow-up Center</h2>
        ...
        <div className="flex items-center gap-3">
          <div className="bg-[#111520] border border-white/[0.06] rounded-xl px-4 py-2.5">
            <div className="text-[11px] text-[#4a5280] uppercase tracking-wider">Today</div>
            <div className="text-[15px] font-bold text-[#ffd166] mt-0.5">{todayFollowups.length}</div>
          </div>
          {overdueFollowups.length > 0 && (
            <div className="bg-[#111520] border border-[#ff4d4d]/20 rounded-xl px-4 py-2.5">
              <div className="text-[11px] text-[#ff4d4d] uppercase tracking-wider">Overdue</div>
              <div className="text-[15px] font-bold text-[#ff4d4d] mt-0.5">{overdueFollowups.length}</div>
            </div>
          )}
        </div>
      </div>
          ...
          <div className="bg-[#6c63ff]/10 border border-[#6c63ff]/20 rounded-lg p-3 mb-3">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button
                ...
                className="text-[11px] text-[#6c63ff] hover:text-[#8b84ff] underline cursor-pointer"
              >
                تطبيق
              </button>
            </div>
