            ...
            {overdueLeads.map((lead) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="bg-[#ff4d4d]/15 text-[#ff4d4d] text-[11px] font-bold px-2 py-0.5 rounded-full whitespace-nowrap">
            ...
            {todayLeads.map((lead) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="bg-[#00d4aa]/15 text-[#00d4aa] text-[11px] font-bold px-2 py-0.5 rounded-full whitespace-nowrap">
                    Today
                  </span>
                  <div className="flex gap-1.5" onClick={(e) => e.stopPropagation()}>
                    <ActionBtn
