    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-[12px] text-[#8892b0] mt-0.5">متابعة جميع اجتماعات الفريق</p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="flex items-center gap-2 shrink-0">
          ...
          <Select value={memberFilter} onValueChange={setMemberFilter}>
            <SelectTrigger className="w-[180px] h-8 bg-[#111520] border-white/[0.06] text-[12px] text-[#f0f2ff]">
              <SelectValue placeholder="كل الفريق" />
            </SelectTrigger>
            <SelectContent className="bg-[#111520] border-white/[0.06] max-h-64 overflow-y-auto">
              <SelectItem value="all" className="text-[12px] text-[#8892b0] focus:text-[#f0f2ff] focus:bg-[#1c2234]">
                كل الفريق
              </SelectItem>
              {allMembers.map((m) => (
                <SelectItem
                  key={m.name}
                  value={m.name}
                  className="text-[12px] text-[#8892b0] focus:text-[#f0f2ff] focus:bg-[#1c2234]"
                >
                  <span className="flex items-center gap-2">
                    <span className={`w-2 h-2 rounded-full ${m.role === 'تيلي' ? 'bg-[#6c63ff]' : 'bg-[#00d4aa]'}`} />
                    {m.name}
                    <span className="text-[10px] text-[#4a5280]">({m.role})</span>
                  </span>
                </SelectItem>
              ))}
            </SelectContent>
        ...
        <div className="flex-1 relative">
          ...
          <Input
            ...
            className="h-8 bg-[#111520] border-white/[0.06] text-[12px] text-[#f0f2ff] placeholder:text-[#4a5280] pr-9"
          />
        </div>
      </div>
