    ...
    <div className="space-y-4 animate-in fade-in duration-200">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-[14px] text-[#8892b0] mt-0.5">إدارة العملاء المحُوَّلين للتلي ماركتنج</p>
        </div>
        <Button
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-b border-white/[0.06] hover:bg-transparent">
                  ...
                  <TableHead className="text-right text-[13px] text-[#4a5280]">حالة التواصل</TableHead>
                  <TableHead className="text-right text-[13px] text-[#4a5280]">حالة العميل</TableHead>
                  ...
                  <TableHead className="text-right text-[13px] text-[#4a5280]">تحويل للسيلز</TableHead>
                  <TableHead className="text-right text-[13px] text-[#4a5280] w-[60px]">إجراء</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {/* ─── Inline Add Row ─── */}
                {showAddRow && (
                  <tr className="border-b border-[#6c63ff]/20 bg-[#6c63ff]/5">
                    ...
                    <TableCell>—</TableCell>
                    <TableCell>
                      <Badge className="bg-[#6c63ff]/15 text-[#a8a3ff] text-[12px] border-0">جديد</Badge>
                    </TableCell>
                    <TableCell>—</TableCell>
                    <TableCell>—</TableCell>
                    <TableCell>
                ...
                {paginatedLeads.length === 0 && !showAddRow ? (
                  <TableRow>
                    <TableCell colSpan={9} className="text-center py-12 text-[#4a5280]">
                      ...
                      <div className="text-[15px]">لا يوجد عملاء</div>
                      <div className="text-[13px] mt-1">اضغط &quot;إضافة عميل&quot; لإضافة عميل جديد</div>
                    </TableCell>
                  </TableRow>
                ) : (
                  paginatedLeads.map((lead) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell>
                          {lead.sales ? (
                            <Badge className="bg-[#00d4aa]/15 text-[#00d4aa] text-[12px] border-0 gap-1">
                              <Send size={8} />
                              {lead.sales}
                            </Badge>
                            ...
                            <div className="flex flex-col gap-1 min-w-[160px]">
                              ...
                              <div className="flex gap-1">
                                <button
                                  ...
                                  className="flex-1 h-6 rounded bg-[#00d4aa]/15 text-[#00d4aa] text-[12px] font-medium hover:bg-[#00d4aa]/25 transition-colors cursor-pointer"
                                >
                                  تحويل ✓
                                </button>
                                <button
