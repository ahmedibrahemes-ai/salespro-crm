                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="text-[10px] text-[#4a5280] shrink-0">
                  ...
                  {/* Unread Badge */}
                  {unread > 0 && (
                    <span className="bg-[#25d366] text-white text-[10px] w-5 h-5 rounded-full flex items-center justify-center font-bold shrink-0">
                      {unread}
                    </span>
                  )}
                </div>
            ...
            <>
              ...
              <div className="px-5 py-3.5 border-b border-white/[0.06] bg-[#111520]/80 backdrop-blur-sm flex items-center gap-3">
                ...
                <div className="mr-auto flex items-center gap-2">
                  <span className="text-[10px] text-[#4a5280] bg-white/[0.04] px-2 py-1 rounded-lg">
              ...
              >
                ...
                <div className="flex items-center gap-3 my-2">
                  ...
                  <span className="text-[10px] text-[#4a5280] bg-white/[0.04] px-3 py-1 rounded-full">
                    اليوم
                  </span>
                  <div className="flex-1 h-px bg-white/[0.06]" />
                </div>
                  ...
                  {messages.length > 0 ? messages.map((msg, i) => (
                    ...
                    >
                      ...
                      <div className={`flex items-center gap-1.5 mt-1 ${msg.fromMe ? 'justify-start' : ''}`}>
                        ...
                        {msg.fromMe && (
                          <span className={`text-[10px] ${msg.read ? 'text-[#25d366]' : 'text-[#4a5280]'}`}>
                            {msg.read ? '✓✓' : '✓'}
                          </span>
                        )}
                      </div>
