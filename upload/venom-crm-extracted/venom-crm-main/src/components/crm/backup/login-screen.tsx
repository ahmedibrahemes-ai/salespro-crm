  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center overflow-hidden bg-[#050a08]">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 70% 60% at 50% 45%, rgba(0,255,136,0.06) 0%, transparent 70%)',
        }}
      />
        ...
        {particles.map((p) => (
          <span
            ...
            style={{
              ...
              width: p.size,
              height: p.size,
              backgroundColor: `rgba(0,255,136,${p.opacity})`,
      ...
      <motion.div
        ...
        className="venom-gradient venom-glow relative z-10 w-full max-w-[420px] rounded-2xl border border-[rgba(0,255,136,0.15)] bg-[rgba(10,20,16,0.85)] px-8 py-10 backdrop-blur-xl sm:px-10"
      >
        {/* ---- Snake logo ---- */}
        <motion.div
          animate={{ y: [0, -8, 0] }}
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="h-11 w-full rounded-lg border border-[rgba(0,255,136,0.2)] bg-[#070e0b] pr-10 pl-3 text-sm text-foreground placeholder:text-muted-foreground outline-none transition-all focus:border-venom focus:ring-2 focus:ring-venom/30"
              autoComplete="email"
              disabled={loading}
            />
          </div>
          ...
          >
            ...
            <span
              ...
              style={{
                boxShadow:
                  '0 0 24px rgba(0,255,136,0.4), 0 0 64px rgba(0,255,136,0.15)',
              }}
            />
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(90deg, transparent, rgba(0,255,136,0.2), rgba(139,92,246,0.2), transparent)',
          }}
        />
